          ...
          return(
                <Container style={[styles.container,{flex:1,justifyContent:'center',flexDirection:'row'}]}>
                    ...
                    <View style={{marginBottom:100,justifyContent:'space-between'}} >
                        ...
                        {/* <CustomButton text="Apply For Job" type="rounded" btnStyle={{justifyContent: 'center',alignSelf: 'center',margin: 5}} onPress={this.handleApply} />
                        <CustomButton text="Proceed To Interview" type="rounded" btnStyle={{margin: 5,justifyContent: 'center',alignSelf: 'center',}} onPress={this.handleApply} />
                        <CustomButton text="Locate Us" type="rounded" btnStyle={{justifyContent: 'center',alignSelf: 'center',margin: 5}} onPress={this.handleApply} /> */}
                    </View>
                  </View>
                </Container>
          )
